export function Tagline() {
  return (
    <div className="hidden md:flex m-10 flex-col justify-center items-center text-center p-12 bg-black/10 backdrop-blur-lg border-l border-white/10 rounded-r-3xl">
